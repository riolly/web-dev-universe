...
image:
  ...
  banner: "./banner.png"
  square: "./square.jpg"
categories: ["GraphQL", "REST", "tRPC", "API", "Back-end"]
pubDate: 2023-06-022
isFeatured: true
---
...
import imgComparison from "assets/images/blogs/trpc_graphql_rest_comparison.png";
...
<div class="md:mx-12">
  <Image
    src={imgComparison}
    alt="tRPC, graphQL, REST API comparison"
    class="rounded"
  />
</div>
...
<div class="mt-2 flex justify-center">
  <blockquote class="twitter-tweet" data-theme="dark">
    <p lang="en" dir="ltr">
      by the way, credit where it’s due — data-driven code splitting in RSC is
      largely inspired by Relay (which has “data-driven dependencies”). RSC
      takes everything we learned about loading code and data over the last ten
      years and synthesizes that into an approach that’s 100% React.
    </p>
    &mdash; дэн (@dan_abramov) <a href="https://twitter.com/dan_abramov/status/1629604899909500928?ref_src=twsrc%5Etfw">February 25, 2023</a>
  </blockquote>
</div>
<script
  defer
...
<iframe
  ...
  allowfullscreen
  class="mx-auto aspect-video w-full md:max-w-xl lg:max-w-2xl"
></iframe>
<br />
Also, check out the GraphQL documentary below, how it starts, and how it become so
popular as we all know it today.
